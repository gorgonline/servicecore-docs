...
## Modülün dört görünümü

Görev Ajandaları, aynı görev kümesini dört ayrı yüzeyde sunar:

| Görünüm | Ne için |
|---|---|
| [Takvim](/docs/teknisyen/moduller/gorevler/takvim) | Teknisyen ajandası; işin *ne zaman* yapılacağı |
| [Liste](/docs/teknisyen/moduller/gorevler/liste) | Tüm alanlarıyla ızgara; süzme ve toplu işlem |
| [Kanban Pano](/docs/teknisyen/moduller/gorevler/kanban) | Süreç başına pano; işin *hangi durumda* olduğu |
| [İş Günlüğü](/docs/teknisyen/moduller/gorevler/is-gunlugu) | Görevlere işlenen süreler |
